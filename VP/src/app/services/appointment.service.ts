...
import { QuantityAppointmentsAttendedByUsersDTO } from '../models/quantityAppointmentsAttendedByUsersDTO';
...
export class AppointmentService {
  ...
  getQuantityCitas(): Observable<QuantityAppointmentsAttendedByUsersDTO[]> {
    return this.http.get<QuantityAppointmentsAttendedByUsersDTO[]>(
      `${this.url}/quantity`
    );
  }
